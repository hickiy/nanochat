...
# Pull HuggingFace datasets through the community mirror instead of a local proxy.
# This avoids the slow/unstable direct connection to huggingface.co (especially
# useful in regions where it is blocked/throttled). Remove this line if you prefer
# to hit huggingface.co directly (e.g. you have a reliable proxy/network).
